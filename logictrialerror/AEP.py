...
class State(rx.State):
    ...
    async def select_vendor(self, vendor: dict):
        ...
        try:
            ...
            print(f"Selecting {vendor_name} for service {self.selected_service}")
...
def service_detail():
    """Service detail component with centered alignment"""
    return rx.cond(
        State.selected_service != "",
        rx.box(
            rx.vstack(
                ...
                rx.center(
                    rx.cond(
                        ...
                        rx.vstack(
                            ...
                            # Provider card with details (your existing code)
                            rx.box(
                                rx.vstack(
                                    # Success icon
                                    rx.html("""
                                        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#00A854" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    ...
                                    # Your existing provider details here
